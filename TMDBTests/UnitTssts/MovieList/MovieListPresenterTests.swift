...
final class MovieListPresenterTests: XCTestCase {
    ...
    func test_ViewDidLoad_CallsInteractorFetchMoviesList() {
        ...
        // Then
        XCTAssertEqual(interactor.fetchMoviesCallsCount, 1,
                       "Expected interactor's fetchMoviesList to be called once")
    }
    ...
    func test_DidFetchMovies_UpdatesMoviesAndReloadsCollectionView() {
        ...
        // Then
        XCTAssertEqual(view.reloadCollectionViewCallsCount, 1,
                       "Expected reloadCollectionView to be called once")
        XCTAssertEqual(presenter.moviesItemsCount, 3,
                       "Expected presenter to have correct number of movies")
    }
    ...
    func test_DidFailToFetchMovies_PresentsErrorToView() {
        ...
        // Then
        XCTAssertEqual(view.presentErrorCallsCount, 1,
                       "Expected presentError to be called once")
        XCTAssertEqual(view.errorMessage, sampleError.localizedDescription,
                       "Expected correct error message to be presented")
    }
    ...
    func test_StopRefreshingIndicator_CallsViewStopRefreshingIndicator() {
        ...
        // Then
        XCTAssertEqual(view.stopRefreshingIndicatorCallsCount,
                       1,
                       "Expected stopRefreshingIndicator to be called once")
    }
    ...
    func test_RefreshMovies_CallsInteractorRefreshMovies() {
        ...
        // Then
        XCTAssertEqual(interactor.refreshMoviesCallCount, 1,
                       "Expected interactor's refreshMovies to be called once")
    }
